                               ...
                               int prev_stream)
{
    ...
    uint64_t lowest_bitrate= panda->bitrate[0];
    ...
    *target_bitrate=(uint64_t)__MAX(0,(float)prev_target_bitrate+
    ...
    //msg_Info(s, "target_bitrate=%"PRIu64"\n",*target_bitrate);
    ...
    *target_avg_bitrate =(uint64_t)__MAX(0,((float)prev_target_avg_bitrate -
    ...
    //msg_Info(s, "target_avg_bitrate=%"PRIu64"\n",*target_avg_bitrate);
    ...
    *rate_limit=100000000; /* bit/s */
    ...
    uint64_t bitrate_up,bitrate_down;
    ...
    if(prev_stream < stream_up) {
        ...
        candidate_bitrate=panda->bitrates[bitrate_up];
        ...
        candidate_bitrate=panda->bitrates[bitrate_down];;
    }
